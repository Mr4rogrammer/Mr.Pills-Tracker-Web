            ...
            <div className="navigation-wrapper">
                <div>
                    ...
                    <div className="menu-wrapper">
                        ...
                        <div className={"image-menu-wrapper menu-bottom-margin " + (selctedIndex == 3 ? "selected" : "")} onClick={() => handleClick(3)}>
                            <img className="nav-image" src={require('../../images/book.svg').default} />
                        </div>
